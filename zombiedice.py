...
Aluna: Amanda Kirsten Magarão souza.

Curso: Análise e desenvolvimento de sistemas.

Matéria de raciocinio computacional, turma 1, professor Galbas Milléo Filho.

Implementação do jogo Zombie Dice em linguagem python. Entrega final da semana 8.
'''
...
while rodada == False:
    ...
    #função que reseta o copo e coloca todos os dados retirados novamente depois de cada partida
        while not turno:
            def resetarcopo():
                dados = ['dVerde', 'dVerde', 'dAmarelo', 'dVermelho', 'dVerde', 'dVerde', 'dAmarelo', 'dVermelho', 'dVerde',
